...
public final class UnderlineStyle: EntryViewStyle {
    ...
    private var _emptyLineColor: UIColor
    ...
    public required init(
        ...
        emptyLineColor: UIColor? = nil) {
            ...
            if let emptyLineColor = emptyLineColor {
                _emptyLineColor = emptyLineColor
            } else {
                _emptyLineColor = lineColor
            }
        }
    ...
    public func onLayoutSubviews(_ label: VKLabel) {
        ...
        if label.text == nil || (label.text?.isEmpty ?? true) {
            _line.strokeColor = _emptyLineColor.cgColor
        } else {
            _line.strokeColor = _lineColor.cgColor
        }
    }
